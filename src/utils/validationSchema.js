import { OrderStatus } from "../enums/order_status.enum.js";
import { PaymentMethod } from "../enums/payment_method.enum.js";
...
export const getMyOrdersValidationSchema = {
    page: {
        in: ["query"],
        optional: true,
        isInt: {
    ...
    createdAt: {
        ...
        optional: true,
        isISO8601: {
            errorMessage: "createdAt must be a valid date (YYYY-MM-DD)"
        }
    }
};

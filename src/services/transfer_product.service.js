...
// import { getCachedBranchIdsRepo } from '../repositories/branch.repository.js';
import { findByBranchId } from "../services/branch.service.js";
import { findUserById } from "../services/user.service.js";
import { findProductsByIds, getProductsByBranch } from "./product.service.js";
import AppErrors from "../utils/appErrors.js";
import { createTransferProductsRepo, getAllRecordsRepo } from "../repositories/transfer_product.repository.js";
import { v4 as uuidv4 } from "uuid";
import { updateStocksBulk, updateStocksBulkWitStockId, getStockByProductIdAndBranchId } from "../services/stock.service.js";
...
const validateProductsOnReceiverBranch = async (branchId, transferProducts) => {
    try {
        const result = await getProductsByBranch(branchId);
...
const validateProductsOnSenderBranchAndGetStocks = async (branchId, transferProducts) => {
    try {
        ...
        const resultOnBranch = await getProductsByBranch(branchId);
        const productsOnBranch = resultOnBranch.products ?? resultOnBranch;
